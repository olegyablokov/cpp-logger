...
TEST_CASE("Log files can be created in current directory", "[logger-filesystem]")
{
...
TEST_CASE("Log files can be created in a subdirectory to the current directory", "[logger-filesystem]")
{
